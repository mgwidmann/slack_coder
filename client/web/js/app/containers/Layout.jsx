...
const Layout = (props) => {
  let { children, ...remainingProps } = props
  const childrenWithProps = React.Children.map(props.children, (child) => React.cloneElement(child, remainingProps));
      ...
      <div>
        <div className="header">
          <div className="container">
            ...
            <Authenticated currentUser={currentUser} onlyAuthenticated={true}>
              <div>
