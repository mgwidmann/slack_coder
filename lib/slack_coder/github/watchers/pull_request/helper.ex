...
#   require Logger
  ...
  # def statuses_for_commit(_pr), do: nil # 404 returned when user deletes branch
  # def statuses_for_commit(pr) do
  #   status = Statuses.find(pr.owner, pr.repo, pr.sha, Github.client)
